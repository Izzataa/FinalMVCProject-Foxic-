...
namespace Foxic.DataAccess.Migrations
{
    ...
    [Migration("20230830123914_CreateAllTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foxic.Core.Entities.ProductOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Foxic.Core.Entities.ProductColor", b =>
                {
                    b.HasOne("Foxic.Core.Entities.Color", "Colors")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Foxic.Core.Entities.ProductOrder", b =>
                {
                    b.HasOne("Foxic.Core.Entities.Order", "Order")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Foxic.Core.Entities.ProductSize", b =>
                {
                    ...
                    b.HasOne("Foxic.Core.Entities.Size", "Sizes")
                        .WithMany("Products")
